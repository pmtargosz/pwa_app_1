...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config */ \"./config.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n{\n  var Gify = function Gify() {\n    var settings = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};\n\n    var updateEl = __checkSelector(settings.update);\n\n    var loadingEl = __checkSelector(settings.loading);\n\n    var resultEl = __checkSelector(settings.result);\n\n    var alertEl = __checkSelector(settings.alert);\n\n    function __checkSelector(el) {\n      return typeof el === 'string' ? document.querySelector(el) : el;\n    }\n\n    ;\n\n    var __toggleClass = function __toggleClass(els, className) {\n      els.map(function (el) {\n        return el.classList.toggle(className);\n      });\n    };\n\n    var __getData =\n    /*#__PURE__*/\n    function () {\n      var _ref = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee() {\n        var response;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                __toggleClass([loadingEl, updateEl], 'd-none');\n\n                _context.prev = 1;\n                _context.next = 4;\n                return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(\"\".concat(_config__WEBPACK_IMPORTED_MODULE_1__[\"config\"].GIPHY_URL, \"api_key=\").concat(_config__WEBPACK_IMPORTED_MODULE_1__[\"config\"].GIPHY_KEY, \"&limit=20\"));\n\n              case 4:\n                response = _context.sent;\n                return _context.abrupt(\"return\", response.data);\n\n              case 8:\n                _context.prev = 8;\n                _context.t0 = _context[\"catch\"](1);\n                console.error(_context.t0);\n                return _context.abrupt(\"return\", _context.t0);\n\n              case 12:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, null, [[1, 8]]);\n      }));\n\n      return function __getData() {\n        return _ref.apply(this, arguments);\n      };\n    }();\n\n    var __renderGifs = function __renderGifs(res) {\n      resultEl.innerHTML = '';\n      var render = res.data.map(function (gif) {\n        return \"\\n            <div class=\\\"col-sm-6 col-md-4 col-lg-3 p-1\\\">\\n                <img class=\\\"w-100 img-fluid\\\" src=\\\"\".concat(gif.images.downsized_large.url, \"\\\">\\n            </div>\\n            \");\n      }).join('');\n      resultEl.innerHTML = render;\n    };\n\n    var update =\n    /*#__PURE__*/\n    function () {\n      var _ref2 = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee2() {\n        var data;\n        return regeneratorRuntime.wrap(function _callee2$(_context2) {\n          while (1) {\n            switch (_context2.prev = _context2.next) {\n              case 0:\n                _context2.next = 2;\n                return __getData();\n\n              case 2:\n                data = _context2.sent;\n\n                if (data) {\n                  __renderGifs(data);\n\n                  alertEl.style.display = 'none';\n                } else {\n                  alertEl.style.display = 'block';\n                }\n\n                __toggleClass([loadingEl, updateEl], 'd-none');\n\n                updateEl.addEventListener('click', update);\n\n              case 6:\n              case \"end\":\n                return _context2.stop();\n            }\n          }\n        }, _callee2);\n      }));\n\n      return function update() {\n        return _ref2.apply(this, arguments);\n      };\n    }();\n\n    return Object.freeze({\n      update: update\n    });\n  };\n\n  var gify = Gify({\n    update: '#update ',\n    loading: '#loading',\n    result: '#giphys',\n    alert: '.alert'\n  });\n  gify.update();\n}\n\n//# sourceURL=webpack:///./src/index.js?");
